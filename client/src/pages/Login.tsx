      ...
      <div class="max-w-md w-full space-y-8 bg-white p-8 rounded-2xl border border-slate-200 shadow-xl">
        <div class="text-center">
          ...
          <p class="mt-2 text-sm text-slate-600">
            Or{' '}
            <Link to="/register" class="font-medium text-brand-600 hover:text-brand-500 transition">
        ...
        <form class="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div class="space-y-4 rounded-md">
            <div>
              <label htmlFor="email-address" class="block text-sm font-medium text-slate-700">
                Email Address
              </label>
          ...
          <div>
            ...
            >
              {loading ? (
                <RefreshCw class="animate-spin h-5 w-5 text-white" />
              ) : (
                'Sign In'
              )}
            </button>
        ...
        <div class="bg-slate-50 p-4 rounded-xl border border-slate-100 mt-6 text-xs text-slate-500 space-y-1">
